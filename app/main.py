...
# Include the shipment tracking router
...
MOCK_PSW_DATA = {
    ...
    "GD-2023-9999": {"gd_number": "GD-2023-9999", "status": "Pending", "location": "Lahore Dry Port"},
}

@app.get("/mock-psw/{gd_number}")
async def mock_psw_endpoint(gd_number: str):
    """
    Simulates the external PSW API.
    """
...
@app.get("/")
async def root():
    return {"message": "Welcome to the Trade-Tech Platform for Pakistani farmers"}
